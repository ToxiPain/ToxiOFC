...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*┊↳☢️┊ Este comando solo puede ser usado por el Propietario/Owner del bot ♛*',
        owner: '*┊↳☢️┊ Este comando solo puede ser usado por el Propietario/Owner del bot ♛*',
        mods: '*┊↳☢️┊ Este comando solo puede ser usado por Moderadores y Owner del bot ♛*',
        premium: '*┊↳☢️┊ Este comando solo puede ser usado por Usuarios Premium y el Owner del bot ♛*',
        group: '*┊↳☢️┊ Este comando solo puede ser utilizado en grupos ♛*',
        private: '*┊↳☢️┊ Este comando solo puede ser usado en el privado del bot ♛*',
        admin: '*┊↳☢️┊ Este comando solo puede ser uilizado por Admins del grupo ♛*',
        botAdmin: '*┊↳☢️┊ Necesito tener Admin para poder utilizar este comando!! ♛*',
        unreg: '*┊↳☢️┊ Registrate para usar esta funcion ♛*\n\n*—◉ Utiliza el comando - /reg nombre.edad*\n*➣ Ejemplo - /reg Juanito.19*',
        restrict: '*┊↳☢️┊ El propietario del bot ha restringido esta funcion... ♛*'
    }[type]
