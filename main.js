...
conn.welcome = '*┊↳☢️┊ Hola Bienvenido/a al grupo!!*\n*━━━━━━━━━━━━━━━━*\n\n👤 *• Nombre:* @user\n📝 *• Descripción:* \n\n• ❝@desc❞\n\n🥀 *Disfruta tu estadía en el grupo.*'
conn.bye = '*★════◈◈◈════★*\n┃• Adiós👋 *@user*\n┃• Vete por la sombrita XD*\n*★════◈◈◈════★*'
conn.spromote = '*┊↳☢️┊ @user Ahora eres Admin 👻*'
conn.sdemote = '*┊↳☢️┊ @user Ya no eres Admin 〽️*'
conn.sDesc = '*┊↳☢️┊ Descripcion del grupo modificada*\n\n*Nueva descripcion:* @desc'
conn.sSubject = '*┊↳☢️┊ Se ha modificado el nombre del grupo*\n*Nuevo Nombre:* @subject'
conn.sIcon = '*┊↳☢️┊ Imagen del grupo actualizada!!*'
conn.sRevoke = '*┊↳☢️┊ El link del grupo fue actualizado*\n*Link Nuevo:* @revoke'
...
let bio = `⏳ 𝙏𝙞𝙚𝙢𝙥𝙤 𝙖𝙘𝙩𝙞𝙫𝙤: ${uptime} ┃ 𝘽𝙤𝙩 𝘽𝙮 𝙏𝙤𝙭𝙞𝙋𝙖𝙞𝙣 ┃ 🔗 Grupo Oficial: https://chat.whatsapp.com/L2smklmfCgCBZZ2c1DzQzt`
