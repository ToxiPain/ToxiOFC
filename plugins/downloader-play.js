...
└───── •✧✧• ─────┘
┌───── •✧✧• ─────┐
👀 *𝚅istas:* ${`${MilesNumber(yt_play[0].views)}`}
└───── •✧✧• ─────┘
┌───── •✧✧• ─────┐
...
const buttonMessage = { image: {url: thumbnail}, caption: capt, footer: '*⠋⠙⠿⠿⠶⠦⠄ Cargando... Por favor espere un momento*', buttons: buttons, headerType: 4 }
let msg = await conn.sendMessage(m.chat, buttonMessage, { quoted: m })
